...
This article is prepared during the add-on course-'Data Analyitcs using R programming'. A questionnaire is prepared and administered through *Google form*. Total number of samples collected in the study is `r size`.
